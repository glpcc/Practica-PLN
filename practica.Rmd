...
Vamos ahora a añadir todas las formas invariables a un archivo txt.

```{r txt}
con <- file(
  description = "Formas_Invariables.txt",
  open = "wt",
  encoding = "UTF-8")

for (i in 1:length(forma_invariable)){
  final = paste("Forma invariable de ",enfermedades3[i], ": ", forma_invariable[i])
  writeLines(final, con)
