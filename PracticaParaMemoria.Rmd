...
head(enfermedades2,5)
tail(enfermedades2,5)
```
...
head(enfermedades3,5)
tail(enfermedades3,5)
```
...
La primera dificultad que nos surgió fue el detectar si las palabras encontradas con los afijos indicados eran enfermedades, o simplemente otras palabras que contenían esos afijos. Nuestra primera solución
